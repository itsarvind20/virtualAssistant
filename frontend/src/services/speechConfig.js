export const speechConfig = {
  ...
  transcriptionLanguage: import.meta.env.VITE_TRANSCRIPTION_LANG || "",
  ttsVoice: import.meta.env.VITE_TTS_VOICE || "",
  ttsRate: Number(import.meta.env.VITE_TTS_RATE || 0.92),
  ttsPitch: Number(import.meta.env.VITE_TTS_PITCH || 1.04),
  ttsVolume: Number(import.meta.env.VITE_TTS_VOLUME || 1),
  cloudTranscriptionEnabled: import.meta.env.VITE_CLOUD_TRANSCRIPTION_ENABLED === "true",
